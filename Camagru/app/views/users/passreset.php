		...
		<form class="myreset" action="/users/passreset/<?php if (isset($data['id'])) echo $data['id'] ?>" method="post">
			<div class="field">
				...
				<div class="control has-icons-left has-icons-right">
					<input class="input" name="password" type="password" value="<?php if (!isset($data['password_err'])) echo $data['password']; ?>" required>
			...
			<div class="field">
				...
				<div class="control has-icons-left has-icons-right">
					<input class="input" name="c_password" type="password" value="<?php if (!isset($data['c_password_err'])) echo $data['c_password']; ?>" required>
					<span class="icon is-small is-left">
						<i class="fas fa-lock"></i>
					</span>
				</div>
