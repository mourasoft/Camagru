...
<div class="form">
		...
		<form action="/edits/pass" class="myedit" method='post'>
			<div class="field">
				...
				<div class="control has-icons-left has-icons-right">
					<input class="input" name="new_password" type="password" value="<?php if (!$data['new_password_err']) echo $data['new_password'] ?>" required>
			...
			<div class="control has-icons-left has-icons-right">
				<input class="input" name="cn_password" type="password" value="<?php if (!$data['cn_password_err']) echo $data['cn_password'] ?>" required>
				<span class="icon is-small is-left">
					<i class="fas fa-lock"></i>
				</span>
			</div>
	...
	<div class="control has-icons-left has-icons-right">
		<input class="input" name="oldpassword" type="password" value="" required>
		<span class="icon is-small is-left">
			<i class="fas fa-lock"></i>
		</span>
	</div>
